...
size_t Vocab::size() const noexcept { return words.size(); }
...
std::vector<llu> Vocab::get_count() const noexcept { return words_count; }

llu Vocab::get_count(size_t i) const { return words_count[i]; }

llu Vocab::get_total_count() const noexcept { return vocab_count; }
